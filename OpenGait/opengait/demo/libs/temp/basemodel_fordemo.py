...
sys.path.append(os.path.dirname(os.path.dirname(os.path.dirname( os.path.abspath(__file__)))) + "/tool/tools/")
print("####### path #######")
print(          os.path.dirname(os.path.dirname(os.path.dirname( os.path.abspath(__file__)))) + "/tool/tools/")
import backbonesDemo
# from backbones import*
# from . import backbonesDemo

sys.path.append(os.path.dirname(os.path.dirname(os.path.dirname( os.path.abspath(__file__)))))
from data.transform import get_transform
from data.collate_fn import CollateFn
# from data.dataset_demo import DataSet
from data.dataset_final import DataSet
...
class InterfaceModel(MetaModel, nn.Module):
    """Base model.
    ...
    def __init__(self, cfgs, training, compare=False):
        ...
        self.save_path = "./gait_model/Baseline-60000.pt"
    ...
    def get_backbone(self, backbone_cfg):
        ...
        if is_dict(backbone_cfg):
            Backbone = get_attr_from([backbonesDemo], backbone_cfg['type'])
        ...
        for inputs in model.train_loader:
            ...
            if model.iteration % model.engine_cfg['save_iter'] == 0:
                ...
                if model.engine_cfg['with_test']:
                    ...
                    model.eval()
                    result_dict = InterfaceModel.run_test(model)
                    model.train()
