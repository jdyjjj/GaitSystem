...
class DataSet(tordata.Dataset):
    def __init__(self, data_cfg, training, compare=False):
        """
            seqs_info: the list with each element indicating 
                            a certain gait sequence presented as [label, type, view, paths];
        """
        self.__dataset_parser(data_cfg, training, compare)
    ...
    def __dataset_parser(self, data_config, training, compare=False):
        # dataset_root = data_config['dataset_root']
        dataset_root = data_config['probeset_root'] if compare else data_config['dataset_root']
        try:
        ...
        compare_set = partition["COMPARE_SET"]
        ...
        compare_set = [label for label in compare_set if label in label_list]
